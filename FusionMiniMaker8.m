function [fusionOut, proteinOut, dataOut] = FusionMiniMaker8(fusionChannelMovie, proteinChannelMovie, coords, fusionMovieName, proteinMovieName,averageCellIntensityWholeMovieFusion)
...
for i = 2:Size4D
    ...
    datatemp = MiniStackFusionDataProcessV9(activeFusionMiniStack,activeProteinMiniStack,fusionStkFileName,proteinStkFileName,averageCellIntensityWholeMovieFusion);
